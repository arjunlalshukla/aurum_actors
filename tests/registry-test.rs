use aurum::{core::{ActorName, Case}, unified};
use aurum::core::{Actor, ActorContext, Node, RegistryMsg, Socket, Host, serialize};
...
fn registry_test() {
  ...
  (&node.registry)(RegistryMsg::Forward(echo_name, <RegTestTypes as Case<String>>::VARIANT, str_ser));
